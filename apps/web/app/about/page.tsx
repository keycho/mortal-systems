...
/**
 * the product page, at /about since the wall took the root: the wall is
 * the front door and this is the room behind it. the gate's "about
 * mortal" link lands here; the hero's watch cta and the footer link
 * lead back out to the wall.
 */
