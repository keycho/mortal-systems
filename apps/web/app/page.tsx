...
/**
 * the landing page, and the front door: the root opens on the hero, and
 * the wall moves to /gate, where the hero's own "watch the live agents"
 * leads. /about stays as an alias for old links.
 *
 * recreated from the design handoff. copy is the
...
/**
 * the front door: the root opens on the hero. the wall is the room
 * behind it, at /gate, where the hero's watch cta and the footer's
 * "the wall · live" lead; the gate's own foot link comes back here.
 * /about stays as an alias for anything already pointing at it.
 */
