...
import { IdentityRow, spaceLabel } from "../src/components/IdentityRow.js";
...
describe("identity row", () => {
  it("renders the numbered space label, name, and state", () => {
    render(<IdentityRow summary={base} />);
  ...
  it("shows a live countdown for finite lifetimes", () => {
    ...
    render(<IdentityRow summary={summary} now={now} />);
  ...
  it("renders destroyed identities as closed, with no actions", () => {
    ...
    render(<IdentityRow summary={summary} />);
